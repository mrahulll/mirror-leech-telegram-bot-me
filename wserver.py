...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://telegra.ph/file/010c77496dc7b045e0aca.jpg" type="image/jpg">
    <script
    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/m2dpublic"> 
          <h2 class="name">M2D</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://t.me/m2dpublic"><i class="fab fa-github"></i></a>
        <a href="https://t.me/m2dpublic"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
async def homepage(request):
    ...
    return web.Response(text="<h1>See M2D <a href='https://t.me/m2dpublic'>@Telegram</a> By <a href='https://t.me/m2dpublic'>Ciara</a></h1>", content_type="text/html")
